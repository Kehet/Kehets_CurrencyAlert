local CurrencyAlert = LibStub("AceAddon-3.0"):NewAddon("Kehet's CurrencyAlert", "AceEvent-3.0", "AceConsole-3.0", "AceTimer-3.0")
            ...
            options.args.currencies.args[categoryName:lower()].args["currency_" .. currencyID] = {
                ...
                args = {
                    enabled = {
                        ...
                        order = 1,
                        get = function(info)
                            return CurrencyAlert.db.profile.currencies[currencyID].enabled or false
                        end,
                    ...
                    threshold = {
                        ...
                        disabled = function()
                            return not CurrencyAlert.db.profile.currencies[currencyID].enabled
                        end,
                    }
                }
            }
